...
impl ModeMask {
    ...
    pub const ANY: ModeMask = ModeMask(0b1111);
...
pub const HOTKEYS: &[Hotkey] = &[
    ...
    Hotkey { key: "↑ / ↓",      action: "move selection",  modes: ModeMask::SEARCH.or(ModeMask::COMMAND) },
    Hotkey { key: "enter",      action: "play selection",  modes: ModeMask::SEARCH },
    Hotkey { key: "enter",      action: "run command",     modes: ModeMask::COMMAND },
    Hotkey { key: "esc",        action: "close / back",    modes: ModeMask::SEARCH.or(ModeMask::HELP).or(ModeMask::COMMAND) },
